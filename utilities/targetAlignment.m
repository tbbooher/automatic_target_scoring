function usedRegistered = targetAlignment(movingName)
% Requests coregistration of targets (one used, one new)
% clear; close all; clc;

%%
cleanTarget = imread('cleanTarget.png');
used = imread(movingName);
...
[usedTargetCenter, ~] = detectCircles(redUsed, radiusRangeUsedTarget);
